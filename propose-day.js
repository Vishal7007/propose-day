document.addEventListener('DOMContentLoaded', () => {
    ...
    function startProposal() {
        ...
        text.textContent ="";
         currentMessage = romanticMessages[Math.floor(Math.random() * romanticMessages.length)];
    ...
    yesBtn.addEventListener('click', () => {
        ...
        celebration.style.cssText = `
            ...
            text-align: center;
        `;
        celebration.innerHTML = '<image src="propose-day.png"></image><br>Forever Yours!<br> Vishal ❤️ Shubhangi ';
